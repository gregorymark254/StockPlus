    ...
    <nav>
      <ul className='border border-slate-300 rounded-md flex gap-4 items-center'>
        <li className='px-3 py-1.5'>
          <button className='text-[#6571ff]' onClick={goToPrevPage} disabled={currentPage === 1}>
            Previous
          </button>
        </li>
        {generatePageNumbers().map((page) => (
          ...
          >
            <button
              ...
              className={`${currentPage === page ? 'current-page bg-[#6571ff] px-3 py-1.5 text-white' : 'text-[#6571ff]'}`}
            >
              {page}
            </button>
          </li>
        ...
        <li className='px-3 py-1.5'>
          <button className='text-[#6571ff]' onClick={goToNextPage} disabled={currentPage === nPages}>
            Next
          </button>
        </li>
      </ul>
